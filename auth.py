...
# Server Parameters
client_url = "https://vibester.herokuapp.com" # for localhost use change to "http://127.0.0.1"
port = 8080
redirect_uri = f"{client_url}/callback/q" # for local host use insert ":{port}" after "{client_url}"
